...
export const serviceDetails = {
  ...
  'start-online': {
    ...
    scope: ['uporządkowanie podstawowych informacji o firmie', 'pomoc przy wizytówce Google', 'podstawowe profile społecznościowe', 'jasne opisy firmy i usług', 'wskazówki co publikować i jak prowadzić pierwszy kontakt', 'prosta ścieżka kontaktu dla klientów', 'opcjonalnie strona startowa lub landing page'],
    process: [
    ...
    faq: [
      ...
      ['Czy Start online może później rozwinąć się w pełną stronę internetową?', 'Tak. To może być pierwszy etap, po którym łatwiej przygotować pełną stronę, landing page albo ofertę PDF.'],
    ],
