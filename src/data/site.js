...
export const services = [
  ...
  {
    title: 'Start online',
    href: '/uslugi/start-online',
    description:
      'Pomoc w uporządkowaniu wizytówki Google, profili społecznościowych, kontaktu i pierwszych kroków online.',
    points: ['Wizytówka Google', 'Profile społecznościowe', 'Kontakt i linki', 'Plan działań'],
  },
];
...
export const projects = [
  {
    ...
    title: 'Barman Duszek',
    description:
      'Landing page dla mobilnej obsługi barmańskiej z Gniezna. Strona pokazuje klimat usługi, zakres obsługi wesel i eventów oraz prowadzi użytkownika do sprawdzenia wolnego terminu.',
    goal: 'Stworzenie strony, która nie tylko informuje o ofercie, ale też buduje atmosferę usługi i zachęca do kontaktu w sprawie terminu.',
    scope: ['Projekt landing page', 'Responsywna strona', 'Sekcje ofertowe', 'Opinie klientów', 'FAQ', 'Formularz zapytania o termin', 'CTA pod rezerwację', 'Wdrożenie online'],
    homepageTags: ['landing page', 'branża eventowa', 'formularz zapytania', 'lokalne SEO'],
    industry: 'Mobilny bar / obsługa eventów',
    benefits: ['mocne pierwsze wrażenie', 'jasna oferta dla wesel i eventów', 'zaufanie przez opinie i FAQ', 'szybka ścieżka do sprawdzenia terminu'],
    result: 'Nowoczesny landing page z mocnym pierwszym wrażeniem, wyraźnym CTA i strukturą dopasowaną do lokalnej usługi eventowej.',
    desktop: '/images/projects/barman-duszek-landing-page-desktop.jpg',
    mobile: '/images/projects/barman-duszek-landing-page-mobile.jpg',
    externalUrl: 'https://barmanduszek.pl/',
    ctaLabel: 'Zobacz realizację',
    alt: 'Mockup landing page Barman Duszek',
    mobileAlt: 'Mobilny widok landing page Barman Duszek',
    featured: true,
  },
  {
    type: 'website',
    ...
    homepageTags: ['strona firmowa', 'lokalna usługa', 'realizacje', 'kontakt'],
    industry: 'Tarasy / usługi lokalne',
  ...
  },
  {
    ...
    description:
      'Oferta PDF, która ułatwia codzienną wysyłkę wycen i pozwala szybko podmieniać dane w pliku.',
    ...
    homepageTags: ['oferta PDF', 'wyceny', 'materiał sprzedażowy', 'edytowalny układ'],
    industry: 'Oferta PDF / materiały ofertowe',
...
export const serviceDetails = {
  ...
  'start-online': {
    badge: 'START ONLINE',
    title: 'Start online dla firm bez technicznego chaosu',
    description: 'Pomagam małym firmom uporządkować pierwsze kroki w internecie: wizytówkę Google, profile społecznościowe, podstawowe informacje o firmie, kontakt i prostą obecność online. Bez trudnych pojęć i bez zostawiania Cię samego z technikaliami.',
    primaryCta: 'Chcę uporządkować start online',
    secondaryCta: 'Napisz do mnie',
    secondaryHref: '/kontakt',
    audience: [
      ['Firmy bez uporządkowanej obecności online', 'Gdy masz ofertę, ale klient nie znajduje jasnych informacji o firmie.'],
      ['Lokalni usługodawcy', 'Gdy chcesz lepiej wyglądać w Google, social mediach i pierwszym kontakcie z klientem.'],
      ['Firmy działające głównie z polecenia lub przez Facebooka', 'Gdy potrzebujesz prostego planu, co pokazać online i gdzie kierować klientów.'],
      ['Małe firmy, które chcą wyglądać profesjonalniej', 'Gdy nie chcesz technicznego chaosu, tylko jasne kroki i uporządkowaną komunikację.'],
    ],
    scope: ['uporządkowanie podstawowych informacji o firmie', 'pomoc przy wizytówce Google', 'podstawowe profile społecznościowe', 'jasne opisy firmy i usług', 'dane kontaktowe i linki w jednym porządku', 'wskazówki co publikować i jak prowadzić pierwszy kontakt', 'rekomendacja dalszych działań'],
    process: [
      ['Sprawdzenie sytuacji', 'Patrzymy, co firma już ma online i czego brakuje, żeby wyglądała wiarygodnie.'],
      ['Plan pierwszych kroków', 'Ustalamy, które profile, opisy, linki i informacje warto uporządkować najpierw.'],
      ['Porządkowanie obecności', 'Pomagam przygotować wizytówkę Google, podstawowe profile, kontakt i prostą ścieżkę dla klienta.'],
      ['Wskazówki na start', 'Dostajesz prosty plan, co publikować, co poprawiać i jak dalej rozwijać obecność online.'],
    ],
    when: 'Wybierz Start online, jeśli chcesz po prostu zacząć działać w internecie i nie chcesz samodzielnie ogarniać pierwszych kroków, profili, opisów i kontaktu z klientami.',
    price: 'od 299 zł netto',
    priceHref: '/cennik#internet',
    faq: [
      ['Czy muszę znać się na internecie?', 'Nie. Start online jest właśnie po to, żeby przejść przez pierwsze kroki prostym językiem i bez technicznego chaosu.'],
      ['Czy pomagasz z wizytówką Google?', 'Tak. Mogę pomóc uporządkować lub przygotować podstawowe informacje potrzebne do wizytówki Google.'],
      ['Czy możesz pomóc z Facebookiem lub Instagramem?', 'Tak. Mogę pomóc uporządkować opisy, dane kontaktowe, linki i podstawowe wskazówki do profili społecznościowych.'],
      ['Czy Start online obejmuje stronę internetową?', 'Nie. Start online porządkuje podstawy obecności online. Jeśli będzie potrzebna strona albo landing page, zaproponuję osobny pakiet lub indywidualną wycenę.'],
    ],
    finalTitle: 'Chcesz uporządkować start online?',
    finalText: 'Napisz, co już masz, a czego brakuje. Pomogę ustalić najprostszy sensowny zakres na pierwszy krok.',
    finalCta: 'Chcę uporządkować start online',
  },
};
